...
const MainLayout = () => {
  return (
    <div className="w-full lg:h-screen md:min-h-screen relative top-0 left-0 flex p-1 gap-1">
      ...
      <div className="lg:w-[80%] w-full h-full relative flex flex-col">
        {/* Header */}
        <header className="w-full h-[8vh] px-2 dark:bg-black/8 bg-neutral-800 rounded-lg">
          <Header />
        </header>
